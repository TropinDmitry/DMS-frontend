        ...
        <>
            ...
            <h1 className="text-[2rem] md:text-[2.4rem] font-bold">Поиск</h1>
                <div className="flex flex-col md:flex-row gap-5 mt-5">
                    ...
                    <div className="flex-1">
                        <label className="text-[1.4rem]">Количество символов:</label>
                        <InputField className="default" placeholder="Количество символов" value={fCode} setValue={setFCode} />
                    </div>
                    <div className="flex-1">
                ...
                <div className="flex flex-col md:flex-row gap-5 mt-[12.5px]">
                    <div className="flex-1">
                        <label className="text-[1.4rem]">Тип документа:</label>
                        <DropList
                            selectedValue={fType}
                ...
                <div className={isFilters() ? 'flex justify-center' : 'hidden'}>
                    <button
                        ...
                        className="w-full md:w-[50%] text-[1.3rem] md:text-[1.6rem] text-[white] 
                                bg-red-600 mt-[20px] px-[16px] py-[8px] rounded-md hover:bg-[#1b2e4b] transition-all duration-[1s]"
                    >
            ...
            <div className="flex flex-col md:flex-row items-center md:justify-between 
                    bg-[#f7f7f7] p-[16px] border border-solid border-[#cccccc] mb-[12px] md:mb-0 shadow-4Way">
                <h1 className="text-[1.8rem] md:text-[2.4rem] font-bold">Список исходящих документов</h1>
                <div
                    className={
                        userRole === 'Member'
                            ? 'hidden'
                ...
                <div className="flex items-center justify-between py-3 mx-5">
                    ...
                    <div className="flex items-center">
                        <p className="text-[1.5rem] mr-9">
                            Показать <span>{documentLists?.length === 0 ? 0 : rowStart}</span> от{' '}
                            <span>{rowEnd + documentLists?.length}</span> до <span>{allDocuments?.length}</span> элементов
                        </p>
                        <div
